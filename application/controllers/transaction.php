...
class Transaction extends CI_Controller
{
	...
	public function status($order_id)
	{
		...
		$update = $this->db->query("UPDATE orders SET status_code ='$transaction_status' WHERE order_id='$order_id'");
		if ($update) {
			echo 'Status code updated successfully';
		} else {
			echo 'Status code not updated';
		}
	}
